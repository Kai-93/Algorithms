...
| 快速排序             |          O(n*log2(n)) |   O(n*log2(n))   |           O(n^2) | O(log2(n)) |        |
| 插入排序             |                O(n^2) |       O(n)       |           O(n^2) |       O(1) |        |
| 插入排序(二分法搜索) | O(n*log2(n)) - O(n^2) |       O(n)       |           O(n^2) |       O(1) |        |
| 希尔排序             | O(n*log2(n)) - O(n^2) |   O(n*log2(n))   |       小于O(n^2) |       O(1) |        |
| 选择排序             |                O(n^2) |      O(n^2)      |           O(n^2) |       O(1) |        |
| 堆排序               |          O(n*log2(n)) |   O(n*log2(n))   |     O(n*log2(n)) |       O(1) |        |
